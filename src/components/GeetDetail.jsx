    ...
    return (
      <div className="min-h-screen bg-[#F7F7F7] flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-md p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-[#2F5D71] mb-3 font-khand">Geet Not Found</h2>
          <p className="text-[#2F5D71]/70 mb-6 font-khand">
            The requested Geet could not be found. It may have been removed or relocated.
          </p>
          <Link
            to="/geet"
          ...
          >
            <FaArrowLeft className="mr-2" /> Back to All Geets
          </Link>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#F7F7F7]">
      ...
      <div className="relative h-80 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url(${geet.imageData})` }}
        ></div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6">
          ...
          >
            {/* <div className="inline-flex items-center justify-center mb-4">
              <FaMusic className="text-[#F18056] text-xl mr-2" />
              <span className="text-[#E3DBC2] uppercase tracking-wider text-sm font-khand">Sanskrit Melody</span>
            </div> */}
          ...
          <div className="p-6 md:p-8">
            ...
            {geet.audioUrl && (
              <div className="mt-8 p-4 bg-[#E3DBC2]/30 rounded-lg">
                <h3 className="text-[#2F5D71] font-bold mb-2 font-khand">Listen to the Geet</h3>
                <audio controls className="w-full">
                  <source src={geet.audioUrl} type="audio/mpeg" />
